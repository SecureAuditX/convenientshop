...
class SignupPage(ctk.CTk):
    def __init__(self):
        ...
        try:
            ...
            self.logo_label = ctk.CTk(self.logo_frame, text="Logo Not Found", font=("Arial", 18, "bold"), text_color="#4F46E5")
        ...
        for idx, (label_text, key, placeholder) in enumerate(fields):
            ...
            # Labels
            label = ctk.CTkLabel(self.signup_frame, text=label_text, font=("Arial", 14, "bold"), text_color="#4F46E5", anchor="w")
            label.grid(row=idx*2+1, column=0, padx=40, pady=(0, 2), sticky="w")                                        
